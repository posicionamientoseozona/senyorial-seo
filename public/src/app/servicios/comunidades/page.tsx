...
export const metadata: Metadata = {
  title: "Limpieza de Portales y Escaleras en Palma | Senyorial",
  description: "Limpieza de comunidades en Palma: limpieza de portales, escaleras, pasillos y zonas comunes, con la frecuencia que necesites.",
