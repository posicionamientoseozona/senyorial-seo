...
import { Home, Clock, Sparkles, Shield, Star, Calculator, Phone } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  description: "Limpieza doméstica por horas en Palma de Mallorca. Para particulares, final de obra, mudanzas. Tarifa básica o premium.",
  keywords: ["limpieza doméstica", "Palma de Mallorca", "limpieza hogar", "por horas", "final de obra", "mudanzas", "limpieza profunda"],
  openGraph: {
    title: "Limpieza Doméstica por Horas en Palma de Mallorca",
    description: "Limpieza doméstica por horas en Palma de Mallorca. Para particulares, final de obra, mudanzas",
    type: "website",
    locale: "es_ES",
    siteName: "Senyorial",
...
const structuredData = {
  ...
  "@type": "LocalBusiness",
  "name": "Senyorial",
  "description": "Empresa de limpieza doméstica flexible por horas en Palma de Mallorca",
  "url": "https://senyorial.es/servicios/limpieza-domestica/",
  ...
  "service": {
    ...
    "description": "Servicios flexibles de limpieza doméstica por horas en Palma de Mallorca"
  }
};
    ...
    <Layout>
      <div>
        ...
        <section
          style={{
            height: '100vh',
            backgroundImage: 'url(/images/services/hogares/kitchen-2165756_1920.webp)',
          ...
          <div className="container" style={{position: 'relative', zIndex: 2}}>
            <div style={{maxWidth: '600px', color: 'white'}}>
              ...
              <h1 style={{
                ...
                Limpieza <span style={{color: 'var(--color-secondary)'}}>Doméstica</span> por Horas
              </h1>
              <p style={{
                fontSize: '1.2rem',
