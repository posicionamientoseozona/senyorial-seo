...
export const metadata: Metadata = {
  ...
  description: "Limpieza de oficinas en Palma de Mallorca desde 16,15€/hora. Tarifa Básica o Premium, flexibilidad horaria y control de calidad. Presupuesto gratuito.",
  keywords: ["limpieza oficinas", "Palma de Mallorca", "limpieza comercial", "oficinas", "espacios trabajo", "despachos", "16,15 euros hora"],
  openGraph: {
    title: "Limpieza de Oficinas en Palma de Mallorca | Desde 16,15€/hora",
    description: "Tarifa Básica o Premium, flexibilidad horaria y control de calidad",
    type: "website",
    locale: "es_ES",
    siteName: "Senyorial",
    ...
    <Layout>
      <div>
        ...
        <section
          style={{
            height: '100vh',
            backgroundImage: 'url(/images/services/oficinas/Oficinas-hero.webp)',
