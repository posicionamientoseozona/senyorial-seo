...
import { Hotel, Users, Utensils, Calendar, Phone, Mail, Star } from "lucide-react";
...
export const metadata: Metadata = {
  title: "Limpieza de Hoteles en Palma de Mallorca | Servicio Profesional",
  description: "Limpieza profesional para hoteles en Palma de Mallorca. Habitaciones, baños, zonas comunes y restauración.",
  keywords: ["limpieza hoteles", "Palma de Mallorca", "limpieza profesional", "hoteles", "habitaciones", "zonas comunes", "restauración"],
  openGraph: {
    title: "Limpieza de Hoteles en Palma de Mallorca",
    description: "Limpieza profesional para hoteles en Palma de Mallorca. Habitaciones, baños, zonas comunes",
    type: "website",
    locale: "es_ES",
    siteName: "Senyorial",
...
const structuredData = {
  ...
  "@type": "LocalBusiness",
  "name": "Senyorial",
  "description": "Empresa de limpieza profesional para hoteles en Palma de Mallorca",
  "url": "https://senyorial.es/servicios/hoteles/",
  ...
  "service": {
    "@type": "Service",
    "name": "Limpieza de Hoteles",
    "description": "Servicios de limpieza profesional para hoteles en Palma de Mallorca"
  }
};
    ...
    <Layout>
      <div>
        ...
        <section
          style={{
            height: '100vh',
            backgroundImage: 'url(/images/services/hoteles/IMG_9639-scaled-1-1.webp)',
          ...
          <div className="container" style={{position: 'relative', zIndex: 2}}>
            <div style={{maxWidth: '600px', color: 'white'}}>
              ...
              <div style={{display: 'flex', gap: 'var(--space-md)', flexWrap: 'wrap'}}>
                ...
                <a href="https://wa.me/34611710243" target="_blank" rel="noopener noreferrer" className="btn2">
        ...
        <section style={{padding: 'var(--space-xl) 0', backgroundColor: 'var(--color-background)'}}>
          <div className="container">
            <div style={{textAlign: 'center', marginBottom: 'var(--space-xl)'}}>
              <h2>Preguntas frecuentes sobre nuestro servicio para hoteles</h2>
            </div>
