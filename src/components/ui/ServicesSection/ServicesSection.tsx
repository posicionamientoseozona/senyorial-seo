  ...
  const services = [
    {
      ...
      icon: "/images/services/oficinas/Oficinas-hero.webp",
    ...
    },
    {
      ...
      icon: "/images/services/comunidades/Comunidades-hero.webp",
    ...
    },
    {
      ...
      icon: "/images/services/hogares/kitchen-2165756_1920.webp",
            ...
            <article key={index} className={styles.serviceCard}>
              ...
              <div className={styles.cardFooter}>
                <Link href={service.href} className="btn4">
                  Más información <span className={styles.arrow}>→</span>
                </Link>
              </div>
            </article>
          ))}
      ...
      <div className="container">
        <div className={styles.ctaSection}>
          <div className={styles.ctaCard}>
            <h2 className={styles.ctaTitle}>¿Buscas una empresa de limpieza en Palma de Mallorca?</h2>
